...
VALUES
  ('bb000001-0000-0000-0000-000000000001', 'facility-demo',
...
VALUES
  ('cc000001-0000-0000-0000-000000000001', 'facility-demo',
  ...
  ('cc000001-0000-0000-0000-000000000002', 'facility-demo',
...
VALUES
  ('ee000001-0000-0000-0000-000000000001', 'facility-demo',
   'Disposable Gloves (Medium)', 'supplies', 150, 50, 'box'),
  ('ee000001-0000-0000-0000-000000000002', 'facility-demo',
   'Aspirin 100mg', 'medications', 30, 20, 'strip'),
  ('ee000001-0000-0000-0000-000000000003', 'facility-demo',
   'Adult Diapers (Large)', 'personal', 10, 25, 'pack'),
  ('ee000001-0000-0000-0000-000000000004', 'facility-demo',
...
VALUES
  ('a2000001-0000-0000-0000-000000000001', 'facility-demo',
   'a1b2c3d4-0000-0000-0000-000000000001',
   'Dr. Sami Al-Harbi', 'Cardiology', '2025-05-15',
   'Routine cardiac checkup', NULL, 'nurse-seed'),
  ('a2000001-0000-0000-0000-000000000002', 'facility-demo',
   'a1b2c3d4-0000-0000-0000-000000000002',
...
VALUES
  ('a4000001-0000-0000-0000-000000000001', 'facility-demo',
   'a1b2c3d4-0000-0000-0000-000000000001',
   'Metformin 500mg - Twice Daily', 'Dr. Layla Al-Qahtani', '2025-04-01'),
  ('a4000001-0000-0000-0000-000000000002', 'facility-demo',
   'a1b2c3d4-0000-0000-0000-000000000001',
...
VALUES
  ('a5000001-0000-0000-0000-000000000001', 'facility-demo',
   'a1b2c3d4-0000-0000-0000-000000000001',
   '2025-05-12',
   ...
   'nurse-seed'),
  ('a5000001-0000-0000-0000-000000000002', 'facility-demo',
   'a1b2c3d4-0000-0000-0000-000000000002',
   '2025-05-12',
...
VALUES
  ('a6000001-0000-0000-0000-000000000001', 'vol-seed', 'facility-demo',
...
VALUES
  ('a7000001-0000-0000-0000-000000000001', 'facility-demo',
  ...
  ('a7000001-0000-0000-0000-000000000002', 'facility-demo',
  ...
  ('a7000001-0000-0000-0000-000000000003', 'facility-demo',
...
VALUES
  ('a8000001-0000-0000-0000-000000000001', 'facility-demo',
...
VALUES
  ('b2000001-0000-0000-0000-000000000001', 'facility-demo',
   'a1b2c3d4-0000-0000-0000-000000000001',
   'https://raaya-media.s3.amazonaws.com/memories/garden-walk-ahmad.jpg',
   'Garden Walk with Ahmad', 5, 'nurse-seed'),
  ('b2000001-0000-0000-0000-000000000002', 'facility-demo',
   'a1b2c3d4-0000-0000-0000-000000000002',
...
VALUES
  ('b3000001-0000-0000-0000-000000000001', 'facility-demo',
   'a1b2c3d4-0000-0000-0000-000000000001',
   'family', 'Good morning from Khalid',
   'https://raaya-media.s3.amazonaws.com/voice/khalid-morning.mp3', 45),
  ('b3000001-0000-0000-0000-000000000002', 'facility-demo',
   'a1b2c3d4-0000-0000-0000-000000000002',
...
VALUES
  ('b4000001-0000-0000-0000-000000000001', 'facility-demo',
   'a1b2c3d4-0000-0000-0000-000000000001',
   'Monthly Care Fee – May 2025', '2025-05', 5000.00, FALSE, '2025-06-01'),
  ('b4000001-0000-0000-0000-000000000002', 'facility-demo',
   'a1b2c3d4-0000-0000-0000-000000000001',
   'Monthly Care Fee – April 2025', '2025-04', 5000.00, TRUE, '2025-05-01'),
  ('b4000001-0000-0000-0000-000000000003', 'facility-demo',
   'a1b2c3d4-0000-0000-0000-000000000002',
